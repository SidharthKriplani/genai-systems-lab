...
export default function PrepLab({ onNavigate, onNavigateTo, initialMode, onClearInitialMode, user = null }) {
  ...
  const PREPLAB_SIDEBAR = [
    ...
    // R1 + R8 (2026-07-03, final): "Interview Signal" (intexp) and "Questions by company" (companyprep)
    //   DELETED entirely — both components + their data removed from this file; not embedded anywhere.
  ...
  return (
    <div className="flex h-full min-h-0">
      ...
      <div className={`${mobileSidebarOpen ? "hidden" : "flex"} flex-col lg:flex flex-1 min-w-0 overflow-y-auto`}>
        ...
        {/* companyprep + intexp: both modes + components DELETED (R1/R8 final). Not rendered anywhere. */}
