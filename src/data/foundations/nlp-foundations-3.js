...
DEPENDENCY PARSE  (arcs: word -> its head)
  ...
  "the" depends on "cat" (determiner); "on" depends on "sat" too,
  tagged pobj = object of the preposition. Word-to-word.
