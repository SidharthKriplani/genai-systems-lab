...
LEFT SIDE — rotate by the absolute positions, then dot:
  ...
  <R(0.9)q, R(2.1)k> = (0.6216)(-0.8632) + (0.7833)(-0.5048) = -0.9321
...
Same answer (the 0.0001 gap is rounding), from two different
computations -- one using positions 3 and 7 directly, one using
only their gap of 4. That agreement IS what "depends only on the
relative offset" means.` },
...
Naive fix "just raise max_position_embeddings":
  ...
  It only removes a length guard; angles still go out of distribution.` },
    ...
    deeperMath: [
      ...
      { type: "illustration", label: "NTK base-scaling formula, checked with real numbers", content: `D = 128 (head_dim), base = 10000, scale s = 8   (4K -> 32K, this
