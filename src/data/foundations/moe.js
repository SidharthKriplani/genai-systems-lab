...
Per-token routing (top-2 of 8 experts):
  ...
  Dense 13B:  ACTIVE = TOTAL = 13B   (one number describes both compute and memory)
  Mixtral:    ACTIVE 13B, TOTAL 47B  → same compute, very different memory footprint` },
